...
plot1 <- p + labs(title=paste0('Number of Cases - ', max.date.txt)) + 
  annotate('segment', x=ymd('2020-02-04'), xend=ymd('2020-02-11'), 
           y=65000, yend=52000, colour='skyblue', size=0.5, 
           arrow=arrow(length=unit(0.2, 'cm'))) +
  geom_text(x=ymd('2020-02-01'), y=73000, 
            label='New criteria introduced \n and new Heads of \n Wuhan & Hubei started',
            color='skyblue', size=2) + 
  annotate('segment', x=ymd('2020-04-10'), xend=ymd('2020-04-16'), 
           y=22000, yend=7000, colour='skyblue', size=0.5, 
           arrow=arrow(length=unit(0.2, 'cm'))) +
  geom_text(x=ymd('2020-04-10'), y=25000, 
